...
export default function WhatsAppChatButton() {
  ...
  return (
    <a
      ...
      className="fixed z-50 bottom-5 right-5 sm:bottom-7 sm:right-7 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-lg transition-colors"
