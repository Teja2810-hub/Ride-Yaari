...
import { X, Calendar, Clock, DollarSign, Save, Plane, Plus } from 'lucide-react'
...
interface TripRequestEditModalProps {
  ...
  onClose: () => void
  request: TripRequest
  onSave: (updatedRequest: Partial<TripRequest>) => void
}
...
export default function TripRequestEditModal({
  ...
  const [departureAirport, setDepartureAirport] = useState(request.departure_airport)
  const [destinationAirport, setDestinationAirport] = useState(request.destination_airport)
  ...
  const handleSave = () => {
    ...
    const updatedRequest: Partial<TripRequest> = {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200">
          ...
          <button
            onClick={handleSave}
            disabled={loading || !departureAirport || !destinationAirport}
