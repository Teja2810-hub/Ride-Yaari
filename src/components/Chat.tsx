...
export default function Chat({ onBack, otherUserId, otherUserName, preSelectedRide, preSelectedTrip }: ChatProps) {
  ...
  const cancelPassengerRequest = async (
           ...
           isCurrentUserOwnerOfConfirmation() && (
            <div className="mb-4 bg-orange-50 border border-orange-200 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-orange-900">Passenger Request Cancelled</h4>
                  <p className="text-sm text-orange-800">
                    The passenger cancelled their request for this {ride ? 'ride' : 'trip'}.
                  </p>
                </div>
              </div>
            </div>
