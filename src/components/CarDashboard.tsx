      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="max-w-full sm:max-w-xl md:max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 px-2">
            {/* Request a Ride Card */}
            <div
              className="group cursor-pointer bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 p-4 sm:p-6"
              onClick={onRequestRide}
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-purple-600 to-purple-700 rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Send size={24} className="sm:w-7 sm:h-7 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Request a Ride</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                  Let drivers in your area know you need a ride and get notified when matching rides are posted
                </p>
                <div className="inline-flex items-center text-purple-600 font-semibold group-hover:text-purple-700 text-xs sm:text-sm">
                  Send Ride Request
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-green-600 to-green-700 rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
                  <PlusCircle size={24} className="sm:w-7 sm:h-7 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Post a Ride</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                  Share your car ride with other travelers to split costs and reduce environmental impact
                </p>
                <div className="inline-flex items-center text-green-600 font-semibold group-hover:text-green-700 text-xs sm:text-sm">
                  Offer Your Ride
                  <div className="ml-2 transform group-hover:translate-x-1 transition-transform">→</div>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Search size={24} className="sm:w-7 sm:h-7 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Find a Ride</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 leading-relaxed">
                  Search for available rides in your area and connect with drivers for affordable travel
                </p>
                <div className="inline-flex items-center text-emerald-600 font-semibold group-hover:text-emerald-700 text-xs sm:text-sm">
          ...
          <div className="mt-8 sm:mt-16 bg-white rounded-2xl shadow-lg p-4 sm:p-8 mx-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Request, Post, or Search</h4>
                <p className="text-gray-600 text-xs sm:text-sm">Request a ride, post your own ride, or search for available rides on your route</p>
              </div>
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Connect & Match</h4>
                <p className="text-gray-600 text-xs sm:text-sm">Get matched with drivers or passengers based on your location and timing preferences</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-green-600 rounded-full flex items-center justify-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Chat & Travel</h4>
                <p className="text-gray-600 text-xs sm:text-sm">Use our secure chat to discuss details, then meet and enjoy cost-effective, eco-friendly travel</p>
              </div>
            </div>
          </div>
