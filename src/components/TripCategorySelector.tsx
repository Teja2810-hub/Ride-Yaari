...
import { ArrowLeft, Plane, User, Calendar, Clock, MapPin, MessageCircle, CreditCard as Edit, Trash2, History, Send, Plus, X, TriangleAlert as AlertTriangle, CircleCheck as CheckCircle } from 'lucide-react'
import { RideConfirmation, Trip, TripRequest } from '../types'
...
export default function TripCategorySelector({
  ...
  const handleDeleteRequest = async (requestId: string) => {
    ...
    try {
      ...
      alert('Failed to delete trip request: ' + error.message)
    }
  }
  ...
  const handleSaveRequest = async (updatedRequest: Partial<TripRequest>) => {
    ...
    try {
      ...
      alert('Failed to update trip request: ' + error.message)
    }
  }

  const showDeleteConfirmation = (type: 'trip' | 'request', id: string, name: string) => {
  ...
  const handleViewRequestDetails = (request: TripRequest) => {
    ...
    return (
      <div>
        <div className="mb-6">
          ...
          <p className="text-gray-600">Manage your airport trips and travel requests</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Trips You've Offered</h3>
              <p className="text-gray-600 mb-4">View and manage your posted airport trips</p>
              <div className="text-2xl font-bold text-blue-600">{offeredTrips.length}</div>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Trips You've Joined</h3>
              <p className="text-gray-600 mb-4">View trips you've requested to join</p>
              <div className="text-2xl font-bold text-indigo-600">{joinedTrips.length}</div>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Trips You've Requested</h3>
              <p className="text-gray-600 mb-4">View your trip assistance requests</p>
              <div className="text-2xl font-bold text-purple-600">{requestedTrips.length}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        {offeredTrips.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Trips Posted</h3>
            <p className="text-gray-600">You haven't posted any airport trips yet.</p>
          </div>
        ) : (
              ...
              <div key={trip.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <TripClosureControls trip={trip} onUpdate={onRefresh} />
                    ...
                    <button
                      onClick={() => {
                        const tripName = `${trip.leaving_airport} → ${trip.destination_airport}`
                        showDeleteConfirmation('trip', trip.id, tripName)
                      }}
  ...
  if (tripView === 'joined') {
    return (
      <div>
        ...
        {/* Implementation would go here - similar to rides */}
      </div>
    )
  }
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Trips You've Requested</h2>
          </div>
        ...
        {requestedTrips.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Trip Requests</h3>
            <p className="text-gray-600">You haven't requested any trips yet.</p>
          </div>
        ) : (
          <div className="space-y-4">
              ...
              <div key={request.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      onClick={() => {
                        const requestName = `${request.departure_airport} → ${request.destination_airport}`
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Delete {showDeleteModal.type === 'trip' ? 'Trip' : 'Request'}
              </h2>
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="font-medium text-gray-900">{selectedRequest.departure_airport}</div>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">To</p>
                    <div className="font-medium text-gray-900">{selectedRequest.destination_airport}</div>
                  </div>
                </div>
              </div>
