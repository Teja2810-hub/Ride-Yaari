...
import { Check, X, MessageCircle, Car, Plane, Calendar, MapPin, Clock, User, TriangleAlert as AlertTriangle, History, RotateCcw, RefreshCw, Trash2 } from 'lucide-react'
      ...
      <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            {confirmation.status === 'accepted' && !isExpired && (
              <button
            ...
            {confirmation.status === 'rejected' && isCurrentUserPassenger && !isExpired && (
              <div className="flex items-center space-x-2">
