/*
  ...
  1. Storage Bucket Setup
    ...
    - Set up proper storage policies without modifying system tables
...
-- Storage policies (these are applied to the bucket, not the objects table directly)
...
CREATE POLICY IF NOT EXISTS "Profile images are publicly viewable"
