/*
  # Fix Chat RLS Policies and Functions
  ...
  1. Function Updates
    ...
    - Prevent column name ambiguity in RLS policies
...
-- Drop existing functions to recreate with proper parameter names
...
-- Drop existing chat_messages policies to recreate them
